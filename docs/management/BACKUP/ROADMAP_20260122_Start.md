...
- [ ] **2.5. Scene 4: Race Result & Judgment (結果判定)**
    - [ ] **Core Logic**: Implement `RankingCalculator` (Score sorting & Tie-breaking).
    - [ ] **UI Implementation**: Result Table with highlighting (1st/2nd/3rd).
    - [ ] **Copy Function**: Generate final result text for BBS.

- [ ] **2.6. Deployment & Feedback**
    - [ ] **[BLOCKER]** Wait for Scene 4 completion.
